...
assert <map.SetHorizScale hMap 10> "Failed operation!"
...
// Export as a Photoshop RAW file.
map.SaveFile2 <GetMap "HF"> <file.SaveDlg "raw" NULL "RAW files (*.raw)|*.raw|"> false true